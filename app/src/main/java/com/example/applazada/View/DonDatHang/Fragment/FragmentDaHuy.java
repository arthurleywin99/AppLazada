...
import com.example.applazada.Adapter.AdapterSanPhamDaHuy;
...
public class FragmentDaHuy extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /**
         * Lấy danh sách đơn hàng bằng tình trạng đơn là "ĐÃ HUỶ" với user hiện tại đăng nhập
         */
        ApiService.apiService.LayDonHangBangTinhTrangDon(nhanVien.getMaNV(), LocalVariablesAndMethods.DAHUY).enqueue(new Callback<List<SanPhamMua>>() {
            @Override
            public void onResponse(Call<List<SanPhamMua>> call, Response<List<SanPhamMua>> response) {
                ...
                AdapterSanPhamDaHuy adapterSanPhamDaHuy = new AdapterSanPhamDaHuy(getContext(), sanPhamList);
                recyclerDonMua.setLayoutManager(layoutManager);
                recyclerDonMua.setAdapter(adapterSanPhamDaHuy);
                adapterSanPhamDaHuy.notifyDataSetChanged();
            }
