...
public class FragmentDangXyLy extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /**
         * Lấy danh sách đơn hàng bằng tình trạng đơn là "ĐANG XỬ LÝ" với user hiện tại đăng nhập
         */
        ApiService.apiService.LayDonHangBangTinhTrangDon(nhanVien.getMaNV(), LocalVariablesAndMethods.DANGXULY).enqueue(new Callback<List<SanPhamMua>>() {
            ...
            public void onResponse(@NonNull Call<List<SanPhamMua>> call, @NonNull Response<List<SanPhamMua>> response) {
                ...
                AdapterSanPhamDangXuLy adapterSanPhamDangXuLy = new AdapterSanPhamDangXuLy(getContext(), sanPhamList);
                recyclerDonMua.setLayoutManager(layoutManager);
                recyclerDonMua.setAdapter(adapterSanPhamDangXuLy);
                adapterSanPhamDangXuLy.notifyDataSetChanged();
            }
